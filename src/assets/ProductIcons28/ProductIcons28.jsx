...
export const ProductIcons28 = ({ className }) => {
  return (
    <svg
      className={`product-icons-28 ${className}`}
      fill="none"
      height="24"
      viewBox="0 0 24 24"
      width="24"
    ...
    >
      <path
        ...
        fill="url(#paint0_linear_4571_1465)"
      />
      <path
        className="path"
        ...
        fill="url(#paint1_linear_4571_1465)"
      />
      <path
        className="path"
        ...
        fill="url(#paint2_linear_4571_1465)"
      />
      <defs className="defs">
        <linearGradient
          className="linear-gradient"
          gradientUnits="userSpaceOnUse"
          id="paint0_linear_4571_1465"
          x1="8.2422"
          x2="20.5182"
          y1="13.8522"
          y2="13.8522"
