...
export const ProductIcons45 = ({ className }) => {
  return (
    <svg
      className={`product-icons-45 ${className}`}
      fill="none"
      height="24"
      viewBox="0 0 24 24"
      width="24"
    ...
    >
      <path
        ...
        fill="url(#paint0_linear_4571_1453)"
      />
      <path
        className="path"
        ...
        fill="url(#paint1_linear_4571_1453)"
      />
      <path
        className="path"
        ...
        fill="url(#paint2_linear_4571_1453)"
      />
      <defs className="defs">
        <linearGradient
          className="linear-gradient"
          gradientUnits="userSpaceOnUse"
          id="paint0_linear_4571_1453"
          x1="4.34182"
          x2="19.6375"
          y1="14.4112"
          y2="14.4112"
