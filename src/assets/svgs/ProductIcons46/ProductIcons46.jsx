...
export const ProductIcons46 = ({ className }) => {
  return (
    <svg
      className={`product-icons-46 ${className}`}
      fill="none"
      height="24"
      viewBox="0 0 24 24"
      width="24"
    ...
    >
      <path
        ...
        fill="url(#paint0_linear_4571_1459)"
      />
      <path
        className="path"
        ...
        fill="url(#paint1_linear_4571_1459)"
      />
      <path
        className="path"
        ...
        fill="url(#paint2_linear_4571_1459)"
      />
      <defs className="defs">
        <linearGradient
          className="linear-gradient"
          gradientUnits="userSpaceOnUse"
          id="paint0_linear_4571_1459"
          x1="4.27548"
          x2="15.8365"
          y1="7.14244"
          y2="7.14244"
