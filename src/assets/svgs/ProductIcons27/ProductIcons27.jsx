...
export const ProductIcons27 = ({ className }) => {
  return (
    <svg
      className={`product-icons-27 ${className}`}
      fill="none"
      height="24"
      viewBox="0 0 24 24"
      width="24"
    ...
    >
      <path
        ...
        stroke="url(#paint0_linear_4571_1448)"
        strokeMiterlimit="10"
        strokeWidth="2.7"
      />
      <path
        ...
        stroke="url(#paint1_linear_4571_1448)"
        strokeMiterlimit="10"
        strokeWidth="2.7"
      />
      <path
        ...
        fill="url(#paint2_linear_4571_1448)"
      />
      <defs className="defs">
        <linearGradient
          className="linear-gradient"
          gradientUnits="userSpaceOnUse"
          id="paint0_linear_4571_1448"
          x1="2.89818"
          x2="18.1055"
          y1="8.44539"
          y2="8.44539"
