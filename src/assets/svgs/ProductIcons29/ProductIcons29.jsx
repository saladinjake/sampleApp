...
export const ProductIcons29 = ({
  color = "url(#paint0_linear_4571_1624)",
  fill = "url(#paint1_linear_4571_1624)",
  color1 = "url(#paint2_linear_4571_1624)",
  className,
}) => {
  return (
    <svg
      className={`product-icons-29 ${className}`}
      fill="none"
      height="24"
      viewBox="0 0 24 24"
      width="24"
